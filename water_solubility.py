...
st.markdown(""" This Web Application was developed by [Gashaw M.Goshu & and Ahmed try to deploy this ](https://www.linkedin.com/in/gashaw-m-goshu/), Ph.D in Organic Chemistry.""")
